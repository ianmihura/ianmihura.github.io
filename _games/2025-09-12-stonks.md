...
This game is ready to be played in [this cli version](https://github.com/ianmihura/stonks) coded in python. Feel free to download the code and run it locally. No installation needed.
